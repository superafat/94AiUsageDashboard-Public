...
export function WelcomeScreen({ onNavigate }: { onNavigate: (location: AppLocation) => void }) {
  return <main className="welcome-screen">
    <section className="welcome-hero"><span className="welcome-brand">AI</span><p className="screen-eyebrow">AI Usage Companion</p><h1>手機查看 AI 額度，<br />不再靠猜。</h1><p>把 Codex、Antigravity、Claude Code 的額度、重置時間與使用趨勢整理在同一個地方。</p>
    ...
    <section className="welcome-preview" aria-label="產品功能預覽"><div className="welcome-preview__header"><span>AI 額度儀表板</span><b>51%</b></div><div className="welcome-preview__bar"><i /></div><div className="welcome-preview__stats"><span>5 小時額度</span><span>每週額度</span><span>使用統計</span></div></section>
